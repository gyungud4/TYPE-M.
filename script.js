...
const resultData = {
    ...
    ios: { n: "iOS", d: "애플 생태계의 고품질 앱을 제작합니다.", k: "Swift, SwiftUI, Xcode", a: "디테일이 살아있는 프리미엄 앱을 만들어보세요." },
    ...
    ai: { n: "AI", d: "데이터 속에서 가치를 찾는 모델 개발자입니다.", k: "Python, PyTorch", a: "데이터가 들려주는 미래의 소리를 들어보세요." },
    iot: { n: "IoT", d: "사물을 인터넷에 연결하여 제어하는 기술입니다.", k: "Embedded C, Arduino", a: "현실의 사물을 코드로 움직여 보세요." },
    security: { n: "사이버 보안", d: "정보를 보호하고 침입을 방어하는 파수꾼입니다.", k: "Network, Linux, Forensics", a: "정의로운 화이트 해커의 길을 걷게 될 거예요." },
    ...
    network: { n: "IT 네트워크 시스템", d: "전 세계를 잇는 통신 인프라를 구축합니다.", k: "Cisco, TCP/IP", a: "디지털 세상의 혈관을 만드는 전문가입니다." },
